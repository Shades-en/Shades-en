...
<a href="#" target="_blank" rel="noreferrer"><img src="https://skillicons.dev/icons?i=git,bootstrap,c,cpp,css,html,js,docker,react,nodejs,figma,java,flask,django,mysql,mongodb,py,qt,tailwind,firebase,linux,jquery,tensorflow,azure,postman,gcp,unity,fastapi,pytorch,kubernetes,terraform" /></a> 
<br>
<h3>Communities:</h3>
<ul>
